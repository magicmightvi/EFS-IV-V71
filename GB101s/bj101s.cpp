...
BOOL CBJ101S::SendYCGroup_ZS(WORD GroupNo, BYTE Reason ,BYTE bType)
{
    ...
    SendFrameHead_ZS(0x15,Reason);//舟山类型标识0x15    
...
//    BYTE temp;
    ...
    //pSendFrame->Frame68.Data[m_guiyuepara.linkaddrlen+m_guiyuepara.typeidlen] = Num;//ASDU长度,舟山为SEQ
